    ...
    <footer className="bg-gray-900 text-white pt-12 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">ProfileCraft</h3>
            <p className="text-gray-400 mb-4">
              Create stunning portfolio websites to showcase your skills and projects.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/portfolio/demo" className="text-gray-400 hover:text-white transition-colors">Demo</Link></li>
            </ul>
          </div>
